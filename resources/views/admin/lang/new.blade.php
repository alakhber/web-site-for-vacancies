                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            <div class="card-body">
                                <form action="{{ route('back.lang.store') }}" method="post">
                                    @csrf
                                    <div class="row">
                                        <div class="form-group col-lg-6">
                                            <div class="col-md-12">
                                                <input type="text" name="locale" value="{{ old('locale') }}" class="form-control @error('locale') is-invalid @enderror" id="locale" placeholder="Məsələn: az ">
                                                @error('locale')
                                        ...
                                        <div class="form-group col-lg-6">
                                            <div class="col-md-12">
                                                <input type="text" name="country" value="{{ old('country') }}" class="form-control @error('country') is-invalid @enderror" id="country" placeholder="Məsələn: Azərbaycan ">
                                                @error('country')
