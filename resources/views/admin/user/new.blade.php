                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Yeni İstifadəçi</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                                ...
                                <div class="col-lg-3  p-4">
                                    <div class="el-card-item p-0" style="width:80%;margin:auto">
                                        <div class="el-card-avatar el-overlay-1">
                                            <img src="{{ _img('img/default.png') }}" id="profilImage" alt="user" style="border-radius: 20px" />
                                ...
                                <div class="col-lg-9 p-4">
                                    <form action="{{ route('back.user.store') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" name="fullname" value="{{ old('fullname') }}" class="form-control @error('fullname') is-invalid @enderror" id="fullname" placeholder="Ad Soyad ">
                                                @error('fullname')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" name="username" value="{{ old('username') }}" class="form-control @error('username') is-invalid @enderror" id="username" placeholder="İstifadəçi Adı ">
                                                @error('username')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" name="email" value="{{ old('email') }}" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="E-Poçt ">
                                                @error('email')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="password" name="password" value="{{ old('password') }}" class="form-control @error('password') is-invalid @enderror" id="password" placeholder="Şifrə ">
                                                @error('password')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="password" name="password_confirmation" value="{{ old('password_confirmation') }}" class="form-control @error('password_confirmation') is-invalid @enderror" id="password_confirmation" placeholder="Təkrar Şifrə ">
                                        ...
                                        <div class="col-lg-12">
                                            <button type="submit" class="btn btn-success float-right">
                                                <i class="fas fa-user-plus mr-2"></i>Əlavə Et
                                            </button>
                                        </div>
                                    </form>
                                </div>
...
@section('_script')
    ...
    <script>
        ...
        $('.reload').on('click', function() {
            $('#profilImage').attr('src', '{{ _img('img/default.png') }}');
            $('#photo').val('');
        });
    </script>
@endsection
